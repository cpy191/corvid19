...
class EpiModelParameters {
 public:
  ...
  double getPreexistingImmunityProtection() { return fPreexistingImmunityProtection; }
  double *getBaselineVESByAge() { return fBaselineVESByAge; }
  int *getSchoolOpeningDays() { return nSchoolOpeningDays; }
  double *getcpcm() {return fcpcm;}
  double *getcpnh() {return fcpnh;}
  double *getcphcc() {return fcphcc;}
  double *getcphca() {return fcphca;}
  ...
  double getPTRestriction() { return fPTRestriction; }
  ...
  int getPTRestrictionDuration() { return nPTRestrictionDuration; }
